...
class VLMFeedbackDualCam:
    ...
    def __init__(self):
        self.last_feedback = "정면+측면 프레임으로 스쿼트 최저점 피드백을 제공합니다."
        self.rep_count = 0
        self.is_down = False
...
analyzer = VLMFeedbackDualCam()


@app.websocket("/ws/feedback")
async def websocket_endpoint(websocket: WebSocket):
    await websocket.accept()
    print("Client connected (vlm v8 dual-cam)")
    try:
        while True:
        ...
        print("Client disconnected (vlm v8)")
