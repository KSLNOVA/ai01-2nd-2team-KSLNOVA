...
const FALLBACK_YT = {
  스쿼트: 'https://youtu.be/urOSaROmTIk?si=47ionXYqcwigo0dk',
  플랭크: 'https://youtu.be/Zq8nRY9P_cM?si=-2TwKOW4ae7Nd9rg',
};
const FALLBACK_YT_ALT = {
  스쿼트: 'https://youtu.be/9WhpAVOSyl8?si=QQ626-4j0YT7Fj2w',
  플랭크: 'https://youtu.be/v54Jtmi2BwU?si=Gd8zIeWXFTfLExG8',
};
const YT_QUERY_MAP = {
  스쿼트: '스쿼트 운동 자세',
  플랭크: '플랭크 운동 자세',
...
const WS_URL =
  (typeof window !== 'undefined' && window.WS_URL)
    ...
    : (typeof window !== 'undefined' &&
      ...
      ? window.location.origin.replace(/^http/, 'ws') + '/ws/feedback_aigym'
      : 'ws://localhost:8500/ws/feedback_aigym';

// 나중에 DB 연결 예정
const DEFAULT_HISTORY = [
  { date: '2025-12-11', exercise: '스쿼트', set: '5세트', summary: '허리 굽히지 않기' },
  { date: '2025-12-10', exercise: '스쿼트', set: '4세트', summary: '다리 더 굽히기' },
  { date: '2025-12-09', exercise: '스쿼트', set: '5세트', summary: '무릎 안쪽 모임 주의' },
];
...
function App() {
  ...
  const [feedback, setFeedback] = useState('피드백이 표시됩니다.');
    ...
    <div className="app-shell">
      ...
      <div className="app-page">
        ...
        <div className="stage">
          ...
          >
            {showRightPanel ? '▶' : '◀'}
            <span className="edge-label">{showRightPanel ? '닫기' : '열기'}</span>
          </button>
        </div>
      </div>
    </div>
